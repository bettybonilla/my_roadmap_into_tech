...
for publisher_name, cache_value in cache_count_dictonary.items():
	try:
		...
		loss_rate.append((publisher_name, rate)) # https://www.w3schools.com/python/python_tuples.asp
...
for item in loss_rate: 
	publisher_name, rate = item # https://www.w3schools.com/python/python_tuples_unpack.asp
