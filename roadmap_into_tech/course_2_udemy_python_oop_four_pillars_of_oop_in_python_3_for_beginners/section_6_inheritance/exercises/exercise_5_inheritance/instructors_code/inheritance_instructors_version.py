...
class Chair(Furniture):
    def __init__(self):
        # super is used to call base class methods. You will learn more about
        # super in next section.
        # Here we are calling the init of our base class to initialise the
        # type of wood as Teakwood
        super().__init__()
    ...
    def displayChairSpecification(self):
        print(
            "This chair is made of {} and has {} legs".format(
                self._typeOfWood, self.__numberOfLegs
            )
        )
