...
if __name__ == "__main__":
    print("\n----- Test: Instantiates a LinkedList -----\n")
    my_linked_list = LinkedList(4)
    print("head node value:", my_linked_list.head.value)
    print("head node next link:", my_linked_list.head.next)
    print("")

    print("linked list:")
    my_linked_list.display_linked_list()
    print("linked list length:", my_linked_list.length)

    print("\n----- Test: Appends a node to the LinkedList -----\n")
    my_linked_list.append(5)
    print("head node value:", my_linked_list.head.value)
    print("head node next link:", my_linked_list.head.next)
    print("next node value:", my_linked_list.head.next.value)
    print("next node next link:", my_linked_list.head.next.next)
    print("tail node value:", my_linked_list.tail.value)
    print("tail node next link:", my_linked_list.tail.next)
    print("")
    ...
    print("\n----- Test: .pop() on LinkedList with multiple nodes -----\n")
    print("linked list:")
    my_linked_list.display_linked_list()
    print("linked list length:", my_linked_list.length)
    print("")

    print("popped node:", my_linked_list.pop().value)
    print("linked list:")
    my_linked_list.display_linked_list()
    print("linked list length:", my_linked_list.length)

    print("\n----- Test: .pop() on LinkedList with one node -----\n")
    print("linked list:")
    my_linked_list.display_linked_list()
    print("linked list length:", my_linked_list.length)
    print("")
    ...
    print("\n----- Test: .pop() on an empty LinkedList -----\n")
    print("linked list:")
    my_linked_list.display_linked_list()
    print("linked list length:", my_linked_list.length)
    print("")

    print("popped node:", my_linked_list.pop())
    print("linked list:")
    my_linked_list.display_linked_list()
    print("linked list length:", my_linked_list.length)

    print("\n----- Test: Prepends a node to an empty LinkedList -----\n")
    my_linked_list.prepend(3)
    print("linked list:")
    my_linked_list.display_linked_list()
    print("linked list length:", my_linked_list.length)

    print("\n----- Test: Prepends multiple nodes to the LinkedList -----\n")
    ...
    print("\n----- Test: .pop_first() on LinkedList with multiple nodes -----\n")
    print("linked list:")
    my_linked_list.display_linked_list()
    print("linked list length:", my_linked_list.length)
    print("")

    print("popped node:", my_linked_list.pop_first().value)
    print("linked list:")
    my_linked_list.display_linked_list()
    print("linked list length:", my_linked_list.length)
    print("")
    ...
    print("\n----- Test: .pop_first() on LinkedList with one node -----\n")
    print("linked list:")
    my_linked_list.display_linked_list()
    print("linked list length:", my_linked_list.length)
    print("")
    ...
    print("\n----- Test: .pop_first() on an empty LinkedList -----\n")
    print("linked list:")
    my_linked_list.display_linked_list()
    print("linked list length:", my_linked_list.length)
    print("")

    print("popped node:", my_linked_list.pop_first())
    print("linked list:")
    my_linked_list.display_linked_list()
    print("linked list length:", my_linked_list.length)

    print("\n----- Test: .get() on LinkedList with multiple nodes -----\n")
    ...
    print("node value at index 2:", my_linked_list.get(2).value)
    print("node value at index -1:", my_linked_list.get(-1))
    print("node value at index 4:", my_linked_list.get(4))
    print("node value at index 10:", my_linked_list.get(10))

    print("\n----- Test: .set_value() on LinkedList with multiple nodes -----\n")
    ...
    print("\n----- Test: .insert() on LinkedList with multiple nodes -----\n")
    my_linked_list.make_empty()
    my_linked_list.append(1)
    my_linked_list.append(3)
    print("linked list:")
    ...
    print("\n----- Test: .remove() on LinkedList with multiple nodes -----\n")
    my_linked_list.make_empty()
    ...
    print("removed node at index 3:", my_linked_list.remove(3).value)
    print("linked list:")
    my_linked_list.display_linked_list()
    print("linked list length:", my_linked_list.length)
    print("")

    print("removed node at index 0:", my_linked_list.remove(0).value)
    print("linked list:")
    my_linked_list.display_linked_list()
    print("linked list length:", my_linked_list.length)
    print("")

    print("removed node at index 4:", my_linked_list.remove(4).value)
    print("linked list:")
    my_linked_list.display_linked_list()
    print("linked list length:", my_linked_list.length)

    print("\n----- Test: .reverse on LinkedList with multiple nodes -----\n")
    my_linked_list.make_empty()
    my_linked_list.append(1)
    my_linked_list.append(2)
    my_linked_list.append(3)
