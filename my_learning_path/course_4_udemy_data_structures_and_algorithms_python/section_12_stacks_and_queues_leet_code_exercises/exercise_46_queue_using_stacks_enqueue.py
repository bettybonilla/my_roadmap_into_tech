"""
You are given a class MyQueue which implements a queue using two stacks - Your task is to implement the enqueue method
which should add an element to the back of the queue
- To achieve this, you can use the two stacks stack1 and stack2
    ...
    - In order to add an element to the back of the queue, you need to first transfer all elements from stack1 to stack2
    ...
    - Finally, transfer all elements from stack2 back to stack1 in the same way as before, so that the queue maintains
    its ordering
